package uz.almsoft.gateway.config.timezone;

import uz.almsoft.gateway.XbGatewayApplicationApp;
import uz.almsoft.gateway.config.SecurityBeanOverrideConfiguration;
import uz.almsoft.gateway.repository.timezone.DateTimeWrapper;
import uz.almsoft.gateway.repository.timezone.DateTimeWrapperRepository;
 ...
 */
@SpringBootTest(classes = {SecurityBeanOverrideConfiguration.class, XbGatewayApplicationApp.class})
